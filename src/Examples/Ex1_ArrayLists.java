...
//        List <String> allNames = new ArrayList();
        ...
        allNames.add("Robert Downey Jr");   allDollars.add(14327.7);  allOscars.add(true); allFilms.add(56);
        allNames.add("Zoe Saldana");   allDollars.add(14227.7);  allOscars.add(false); allFilms.add(32);
